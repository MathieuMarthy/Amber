...
class $SubscriptionsTable extends Subscriptions
  ...
  @override
  late final GeneratedColumn<int> repeatXTimes = GeneratedColumn<int>(
    'repeat_x_times',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('repeat_x_times')) {
      context.handle(
        _repeatXTimesMeta,
        repeatXTimes.isAcceptableOrUnknown(
          data['repeat_x_times']!,
          _repeatXTimesMeta,
        ),
      );
...
class SubscriptionEntry extends DataClass
  ...
  SubscriptionsCompanion toCompanion(bool nullToAbsent) {
    return SubscriptionsCompanion(
      ...
      repeatXTimes: repeatXTimes == null && nullToAbsent
          ? const Value.absent()
          : Value(repeatXTimes),
  ...
  SubscriptionEntry copyWithCompanion(SubscriptionsCompanion data) {
    return SubscriptionEntry(
      ...
      unitOfTime: data.unitOfTime.present
          ? data.unitOfTime.value
          : this.unitOfTime,
      repeatXTimes: data.repeatXTimes.present
          ? data.repeatXTimes.value
          : this.repeatXTimes,
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final LocalCategoryDao localCategoryDao = LocalCategoryDao(
    this as AppDatabase,
  );
  late final LocalSubscriptionDao localSubscriptionDao = LocalSubscriptionDao(
    this as AppDatabase,
  );
  @override
...
class $$SubscriptionsTableOrderingComposer
  ...
  ColumnOrderings<DateTime> get startDay => $composableBuilder(
    column: $table.startDay,
    builder: (column) => ColumnOrderings(column),
  );
  ...
  ColumnOrderings<int> get unitOfTime => $composableBuilder(
    column: $table.unitOfTime,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<int> get repeatXTimes => $composableBuilder(
    column: $table.repeatXTimes,
    builder: (column) => ColumnOrderings(column),
  );
